                            ...
                            <div class="card hms-table-card">
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Payment.create')}}" class="btn btn-primary btn-hms-primary" role="button"
                                           ...
                                           @foreach($payments as $payment)
                                               <tr>
                                                   ...
                                                   <td>
                                                       ...
                                                       <a href="{{route('Payment.edit',$payment->id)}}" class="hms-action-btn hms-action-btn--edit" title="تعديل"><i class="fas fa-edit"></i></a>
                                                       <a class="modal-effect hms-action-btn hms-action-btn--delete" data-effect="effect-scale" data-toggle="modal" href="#delete{{$payment->id}}" title="حذف"><i class="fas fa-trash"></i></a>
                                                       </div>
