<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" opacity=".3"/><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14z"/></svg>
                <span class="side-menu__label">التحويل والمتابعة</span><i class="angle fe fe-chevron-down"></i>
            </a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('doctor.referrals.index') }}">التحويلات</a></li>
                <li><a class="slide-item" href="{{ route('doctor.follow-ups.index') }}">خطط المتابعة</a></li>
                <li><a class="slide-item" href="{{ route('doctor.certificates.index') }}">الشهادات الطبية</a></li>
            </ul>
        </li>
