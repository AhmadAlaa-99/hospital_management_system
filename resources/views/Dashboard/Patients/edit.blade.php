    ...
    <div class="col">
        <div class="card hms-form-card">
            <div class="card-header">
                <h5 class="mb-0 hms-form-title">تعديل بيانات المريض</h5>
            </div>
            <div class="card-body">
                    <form action="{{route('Patients.update','test')}}" method="post" autocomplete="off" class="hms-form">
                        @method('PUT')
                        @csrf
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            ...
                            <select class="form-control" name="insurance_id">
                                ...
                                @foreach($insurances as $insurance)
                                    <option value="{{ $insurance->id }}" {{ $Patient->insurance_id == $insurance->id ? 'selected' : '' }}>
