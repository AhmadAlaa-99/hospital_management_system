						...
						<div class="card hms-table-card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    <a href="{{route('Ambulance.create')}}" class="btn btn-primary btn-hms-primary">اضافة سيارة جديدة</a>
								</div>
							</div>
							<div class="card-body">
                                        ...
                                        @foreach($ambulances as $ambulance)
											<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('Ambulance.edit',$ambulance->id)}}" class="hms-action-btn hms-action-btn--edit" title="تعديل"><i class="fas fa-edit"></i></a>
                                                    <button type="button" class="hms-action-btn hms-action-btn--delete" data-toggle="modal" data-target="#Deleted{{$ambulance->id}}" title="حذف"><i class="fas fa-trash"></i></button>
                                                    </div>
                                                </td>
											</tr>
