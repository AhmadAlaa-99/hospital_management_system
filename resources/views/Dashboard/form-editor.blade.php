					...
					<div class="d-flex my-xl-auto right-content">
						...
						<div class="mb-3 mb-xl-0">
							<div class="btn-group dropdown">
								<button type="button" class="btn btn-primary btn-hms-primary">14 Aug 2019</button>
						...
						<div class="card hms-form-card">
							<div class="card-body">
								...
								<div class="tx-center pd-y-20 bg-gray-100 border">
									<a class="btn btn-primary btn-hms-primary" data-target="#modalQuill" data-toggle="modal" href="">View Live Demo</a>
								</div><!-- pd-y-30 -->
								<div class="modal">
