        ...
        <div class="col">
            <div class="card hms-table-card">
                <div class="card-header">
                    <a href="{{route('insurance.create')}}" class="btn btn-primary btn-hms-primary">{{trans('insurance.Add_Insurance')}}</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap text-center hms-table" id="example1">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($insurance->status == 1)
                                            <span class="hms-badge hms-badge-success">مفعل</span>
                                        @else
                                            <span class="hms-badge hms-badge-danger">غير مفعل</span>
                                        @endif
                                    </td>
                                    <td>{{$insurance->notes}}</td>
                                    <td>
                                        <div class="hms-actions">
                                        <a href="{{route('insurance.edit',$insurance->id)}}" class="hms-action-btn hms-action-btn--edit" title="تعديل"><i class="fas fa-edit"></i></a>
                                        <button type="button" class="hms-action-btn hms-action-btn--delete" data-toggle="modal" data-target="#Deleted{{$insurance->id}}" title="حذف"><i class="fas fa-trash"></i></button>
                                        </div>
                                    </td>
