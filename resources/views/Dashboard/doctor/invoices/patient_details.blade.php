...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <a href="{{ route('doctor.medical-record.pdf', $patientId) }}" class="btn btn-danger btn-sm">
                                                    ...
                                                    <div class="timeline-wrapper {{ $loop->iteration % 2 == 0 ? 'timeline-inverted' : '' }} timeline-wrapper-primary">
                                                        ...
                                                        <div class="timeline-panel">
                                                            ...
                                                            <div class="timeline-body">
                                                                ...
                                                                @if($patient_record->prescriptions->count())
                                                                    <table class="table table-sm table-bordered mt-2">
                                                                        <tr><th>الدواء</th><th>الجرعة</th><th>التكرار</th><th>المدة</th></tr>
                                                                        @foreach($patient_record->prescriptions as $rx)
                                                                            <tr><td>{{ $rx->medicine_name }}</td><td>{{ $rx->dosage }}</td><td>{{ $rx->frequency }}</td><td>{{ $rx->duration_days }} يوم</td></tr>
                                                                        @endforeach
                                                                    </table>
                                                                @elseif($patient_record->medicine)
                                                                    <p><strong>الأدوية:</strong> {{ $patient_record->medicine }}</p>
                                                                @endif
                                                            </div>
