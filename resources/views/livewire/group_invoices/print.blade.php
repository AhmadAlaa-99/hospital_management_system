...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            ...
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ طباعه فاتورة مجموعة #{{ $invoice->id }}</span>
        </div>
    </div>
</div>
@endsection
            ...
            <div class="card card-invoice">
                <div class="card-body">
                    <div class="invoice-header">
                        <h1 class="invoice-title">فاتورة مجموعة خدمات</h1>
                    ...
                    <div class="row mg-t-20">
                        <div class="col-md">
                            ...
                            <p class="invoice-info-row"><span>اسم المجموعة</span> <span>{{ optional($invoice->Group)->name }}</span></p>
                    ...
                    <div class="table-responsive mg-t-40">
                        <table class="table table-invoice border text-md-nowrap mb-0">
                            ...
                            <tr>
                                <th class="wd-20p">#</th>
                                <th class="wd-40p">اسم المجموعة</th>
                                <th class="tx-center">سعر المجموعة</th>
                            ...
                            <tr>
                                <td>1</td>
                                <td class="tx-12">{{ optional($invoice->Group)->name }}</td>
                    ...
                    <hr class="mg-b-40">
                    <a href="{{ route('group_invoices') }}" class="btn btn-secondary float-left mt-3 ml-2">رجوع</a>
